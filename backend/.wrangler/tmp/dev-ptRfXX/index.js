...
function validateSubscription(data) {
  ...
  const nextBillingDate = data.next_billing_date || data.nextBilling || data.next_billing || data.renewalDate || data.renewal_date || data.nextBillingDate || data.next_billing_Date || data.NextBilling;
  ...
  async getById(id) {
    try {
      ...
      return {
        ...
        updated_at: result.updated_at || (/* @__PURE__ */ new Date()).toISOString()
      };
    } catch (error) {
...
// .wrangler/tmp/bundle-OktUmo/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-OktUmo/middleware-loader.entry.ts

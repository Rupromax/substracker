...
// .wrangler/tmp/bundle-e4NEPb/checked-fetch.js
...
function validateSubscription(data) {
  ...
  if (data.price === void 0 || data.price === null || typeof data.price !== "number" || data.price < 0) {
...
app.get("/api/health", (c) => {
  return c.json({
    success: true,
    data: { ok: true, timestamp: (/* @__PURE__ */ new Date()).toISOString() },
    message: "\u670D\u52D9\u904B\u884C\u6B63\u5E38"
  });
});
...
app.post("/api/subscriptions", async (c) => {
  try {
    ...
    const service = new SubscriptionService(c.env.SUBSCRIPTIONS_KV);
    const subscription = await service.create(body);
    return c.json({
      success: true,
      data: subscription,
      message: "\u5275\u5EFA\u8A02\u95B1\u6210\u529F"
...
// ../../../Users/andy9/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../Users/andy9/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-e4NEPb/middleware-insertion-facade.js
...
// ../../../Users/andy9/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-e4NEPb/middleware-loader.entry.ts
